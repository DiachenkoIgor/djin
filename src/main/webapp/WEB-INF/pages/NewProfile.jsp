        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="position" autocomplete="off" data-provide="typeahead" id="position" class="form-control" value="Разработчик PHP" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <div class="input-group">
                            ...
                            <input type="number" name="salary_min" id="salary_min" step="100" min="100" required="required" autocomplete="off" class="form-control input salary" value="500">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="location" id="location" autocomplete="off" data-provide="typeahead" required="required" class="form-control" value="Киев">
                        <p class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <textarea rows="9" class="form-control" maxlength="750" name="moreinfo" id="moreinfo">PHP, MySQL, Linux, JavaScript</textarea>
            ...
            <div class="col-sm-10">
                ...
                <div id="extraquestions">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" id="id_primary_keyword_cache" name="experience">
                                <option value="0" selected="selected">без опыта</option>
                                <option value="0.5">меньше года</option>
                                <option value="1">год</option>
                                <option value="1.5">1.5 года</option>
                                <option value="2">2 года</option>
                                <option value="2.5">2.5 года</option>
                                ...
                                <option value="11">больше 10 лет</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="english_level" value="0" checked="checked">
                                    Нет английского
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="english_level" value="1">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="english_level" value="2">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="english_level" value="3">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="english_level" value="4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="employment_options" value="fulltime" checked="checked">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="employment_options" value="remote" checked="checked">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea rows="5" class="input form-control" maxlength="750" name="looking_for" id="looking_for"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea rows="5" class="input form-control" maxlength="750" name="highlights" id="highlights"></textarea>
